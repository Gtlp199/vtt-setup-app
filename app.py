...
if nav_option == "🔧 Réglages Suspensions":
    ...
    with st.form("custom_settings_form"):
        ...
        submit_button = st.form_submit_button("💾 Enregistrer ces réglages dans l'historique")
        ...
        if submit_button:
            ...
            st.success("✅ Vos réglages ont été enregistrés avec succès !")

    # HISTORIQUE DES RÉGLAGES
    if st.session_state.settings_history:
        st.subheader("📚 Historique de vos sessions d'essai")
...
# ---------------------------------------------------------
    ...
    * **Étriers de frein Post Mount** : Serrage préconisé à **9.5 Nm**. Centrer l'étrier en maintaining le levier enfoncé.
